...
public:
    ...
    Value* build_fptosi_i32_f32(Value* val);
    Value* build_fptosi_i64_f32(Value* val);
    Value* build_sitofp_f64_i32(Value* val);
    Value* build_sitofp_f64_i64(Value* val);
    Value* build_sitofp_f32_i32(Value* val);
    Value* build_sitofp_f32_i64(Value* val);
    Value* build_fptrunc_f32_f64(Value* val);
    ...
    Value* build_sqrt(Value* val);
    Value* build_sqrt_f32(Value* val);
    Value* build_sqrt_f64(Value* val);
    Value* build_floor(Value* val);
    Value* build_floor_f32(Value* val);
    Value* build_floor_f64(Value* val);
    Value* build_ceil(Value* val);
    Value* build_ceil_f32(Value* val);
    Value* build_ceil_f64(Value* val);
    Value* build_round(Value* val);
    Value* build_round_f32(Value* val);
    Value* build_round_f64(Value* val);
    Value* build_fabs(Value* val);
    Value* build_fabs_f32(Value* val);
    Value* build_fabs_f64(Value* val);
    Value* build_fmin(Value* lhs, Value* rhs);
    Value* build_fmin_f32(Value* lhs, Value* rhs);
    Value* build_fmin_f64(Value* lhs, Value* rhs);
    Value* build_fmax(Value* lhs, Value* rhs);
    Value* build_fmax_f32(Value* lhs, Value* rhs);
    Value* build_fmax_f64(Value* lhs, Value* rhs);
